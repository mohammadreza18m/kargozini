  ...
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/80 backdrop-blur-md">
      <div className="flex items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div>
          <h1 className="text-base font-semibold text-slate-800 lg:text-lg">Personnel Decree Platform</h1>
          <p className="text-xs text-slate-500 lg:text-sm">Unified rule administration and decree issuance for HR teams</p>
        </div>
